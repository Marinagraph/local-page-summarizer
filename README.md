...
- If likely comments are found, all currently visible comment candidates are analyzed. Sites are not paginated automatically except for supported Danawa product pages.
