...
- Long summaries run in the extension background, so the popup can close and you can keep using the browser, another browser, or other apps while the job continues.
